...
func MapStrFromJournalEntry(ev *sdjournal.JournalEntry, cleanKeys bool, convertToNumbers bool, MoveMetadataLocation string, whitelistedFields []string) common.MapStr {
	m := common.MapStr{}
